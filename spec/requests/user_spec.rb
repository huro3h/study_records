...
RSpec.describe UsersController, type: :request do
  ...
  describe 'POST #create' do
    context '正常に登録完了した時' do
      it 'ステータス302が返ること' do
        post users_path params: { user: { name: "Sample Taro", password: 123456, password_confirmation: 123456 } }
    ...
    context '登録項目に不備がある時' do
      it 'ステータス422が返ること' do
        post users_path params: { user: { name: nil, password: nil, password_confirmation: nil } }
